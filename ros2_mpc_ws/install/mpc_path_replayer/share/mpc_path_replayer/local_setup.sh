...
: ${AMENT_CURRENT_PREFIX:="/ws/install/mpc_path_replayer"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mpc_path_replayer/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mpc_path_replayer/environment/path.sh"
